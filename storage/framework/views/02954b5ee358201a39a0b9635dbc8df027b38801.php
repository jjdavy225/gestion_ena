...
<?php $__env->startSection('contenu'); ?>
    <div class="container">
        <form action="<?php echo e(route('type_article.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="container mt-3">
                <h3 class="text-center">Renseignez le nouveau type</h3>
            </div>
...
<?php echo $__env->make('template.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davy/gestion_ena_backup/resources/views/type_article/create.blade.php ENDPATH**/ ?>