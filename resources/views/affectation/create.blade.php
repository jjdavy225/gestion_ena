    ...
    <div class="container">
        <form action="{{ route('affectation.store') }}" method="post">
            ...
            <div class="container mt-3">
                <h3 class="text-center">Renseigner les infos pour l'affectation</h3>
            </div>
                ...
                <div class="col-lg-6">
                        ...
                        <select id="conducteur_principal" required
                            ...
                            @foreach ($conducteurs as $conducteur)
                                <option value="{{ $conducteur->id }}"
                                    @if ($conducteur->id == old('conducteur_principal')) {{ 'selected' }} @endif>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="conducteur_secondaire"
                            ...
                            @foreach ($conducteurs as $conducteur)
                                <option value="{{ $conducteur->id }}"
                                    @if ($conducteur->id == old('conducteur_secondaire')) {{ 'selected' }} @endif>
                                    {{ $conducteur->agent_conducteur->nom . ' ' . $conducteur->agent_conducteur->prenom }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required class="form-control @error('date_debut') is-invalid @enderror" type="date"
                            name="date_debut" id="date_debut" value="{{ old('date_debut') }}">
                        <div class="invalid-feedback">
                            @error('date_debut')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required class="form-control @error('date_fin') is-invalid @enderror" type="date"
                            name="date_fin" id="date_fin" value="{{ old('date_fin') }}">
                        <div class="invalid-feedback">
                            @error('date_fin')
                                {{ $message }}
                            @enderror
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('direction') is-invalid @enderror" type="text"
                            name="direction" id="direction" value="{{ old('direction') }}">
                        <div class="invalid-feedback">
                            @error('direction')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required class="form-control @error('service') is-invalid @enderror" type="text"
                            name="service" id="service" value="{{ old('service') }}">
                        <div class="invalid-feedback">
                            @error('service')
                                {{ $message }}
                            @enderror
